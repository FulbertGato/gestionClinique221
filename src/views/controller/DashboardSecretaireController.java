 ...
 * @author junio
 */
public class DashboardSecretaireController implements Initializable {
    ...
    @FXML
    private void handleRendezVousValide(ActionEvent event) {
    }

    @FXML
    private void handleRendezVousAnuller(ActionEvent event) {
    }
